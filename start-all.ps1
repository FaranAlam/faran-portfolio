# Starts the newsletter API (port 5000) and the static site (port 8080)
...
# Start Python HTTP server on WebPort
Start-Window -WorkDir $Root -Command "python -m http.server $WebPort"
...
Write-Host "All set! Two windows should be running (Backend API and Python HTTP Server)." -ForegroundColor Green
